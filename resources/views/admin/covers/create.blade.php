...
<form action="{{route('admin.covers.store')}}" method="POST"
    ...
    <figure class="relative mb-4">
        ...
        <img src="{{ asset('img/image-ecommerce.webp')}}" alt="Portada" class="w-full aspect-[3/1] object-cover object-center"
        id="imgPreview">
    </figure>
    ...
    <div class="mb-4">
        ...
        <x-input name="title" value="{{ old('title') }}" class="w-full" placeholder="Ingrese el titulo de la portada" />
    ...
    <div class="mb-4 flex space-x-2">
        <x-label class="flex items-center">
         <x-input type="radio" name="is_active" value="1" checked class="mr-1" />
           Activo
        </x-label>
       
        <x-label class="flex items-center">
         <x-input type="radio" name="is_active" value="0" class="mr-1" />
           Inactivo
        </x-label>
    </div>
