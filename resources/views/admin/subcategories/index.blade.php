<x-admin-layout :breadcrumbs="[['name' => 'Dashboard', 'route' => route('admin.dashboard')], ['name' => 'Subcategorias']]">
    ...
    @else
        <div class="flex items-start sm:items-center p-4 mb-4 text-sm text-fg-brand-strong rounded-base bg-brand-softer"
            ...
            <p><span class="font-medium me-1">Info alert!</span> Todavia no hay subcategorias registradas.</p>
        </div>
    @endif
