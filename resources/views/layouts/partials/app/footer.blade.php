<footer class="bg-indigo-600">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div class="mb-6 md:mb-0">
                <a href="/" class="flex items-center">
                    <div class="flex flex-col">
                        <span class="self-center text-2xl font-bold whitespace-nowrap text-white">Shoply</span>
                        <span class="text-xs text-white/80">Tu tienda online</span>
                    </div>
                </a>
                <p class="mt-4 max-w-xs text-sm text-white/70">
                    La mejor selección de productos de Tecnología, Moda y Hogar con envíos a todo el país.
                </p>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 class="mb-6 text-sm font-bold text-white uppercase tracking-wider">Comprar</h2>
                    <ul class="text-white/80 font-medium space-y-4">
                        <li><a href="#" class="hover:text-white transition-colors">Tecnología</a></li>
                        <li><a href="#" class="hover:text-white transition-colors">Moda Hombre</a></li>
                        <li><a href="#" class="hover:text-white transition-colors">Moda Mujer</a></li>
                        <li><a href="#" class="hover:text-white transition-colors">Hogar</a></li>
                    </ul>
                </div>
                <div>
                    <h2 class="mb-6 text-sm font-bold text-white uppercase tracking-wider">Soporte</h2>
                    <ul class="text-white/80 font-medium space-y-4">
                ...
                <div>
                    <h2 class="mb-6 text-sm font-bold text-white uppercase tracking-wider">Legal</h2>
                    <ul class="text-white/80 font-medium space-y-4">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-white/60 sm:text-center">© {{ date('Y') }} <a href="/" class="hover:underline">Shoply™ by katrix</a>. Todos los derechos reservados.
            </span>
